...
export default function PrivacyPolicyPage() {
  return (
    <section className="container mx-auto py-16 mt-[4.5rem] px-6">
      <h1 className="text-4xl font-bold my-7">Privacy Policy</h1>
      <p className="my-4">Last updated: January 04, 2025</p>
      <p className="my-4">
      ...
      <h3 className="text-2xl font-bold my-6">Interpretation</h3>
      <p className="my-4">
      ...
      <h3 className="text-2xl font-bold my-6">Definitions</h3>
      ...
      <ul className="list-disc my-4 pl-10">
        ...
        <li>
          <p className="my-4">
            ...
            this Agreement) refers to Lotus Tape.
          </p>
        </li>
        <li>
          <p className="my-4">
        ...
        <li>
          <p className="my-4">
            <strong>Website</strong> refers to Lotus Tape, accessible from{" "}
            <Link
              href="https://www.lotustape.com"
              rel="external nofollow noopener"
              target="_blank"
              className="hover:underline"
            >
              https://www.lotustape.com
            </Link>
          </p>
        </li>
        <li>
      ...
      <h3 className="text-2xl font-bold my-6">Types of Data Collected</h3>
      <h4 className="text-xl font-bold my-7">Personal Data</h4>
      <p className="my-4">
      ...
      <h4 className="text-xl font-bold my-7">Usage Data</h4>
      <p className="my-4">
      ...
      <h4 className="text-xl font-bold my-7">
      ...
      <h3 className="text-2xl font-bold my-6">Use of Your Personal Data</h3>
      <p className="my-4">
      ...
      <h3 className="text-2xl font-bold my-6">Delete Your Personal Data</h3>
      <p className="my-4">
      ...
      <h4 className="text-xl font-bold my-7">Business Transactions</h4>
      <p className="my-4">
      ...
      <h4 className="text-xl font-bold my-7">Law enforcement</h4>
      <p className="my-4">
        Under certain circumstances, the Company may be required to disclose
        Your Personal Data if required to do so by law or in response to valid
        requests by public authorities (e.g. a court or a government agency).
      </p>
      <h4 className="text-xl font-bold my-7">Other legal requirements</h4>
      <p className="my-4">
      ...
      <h2 className="text-4xl font-bold my-7">Children&#39;s Privacy</h2>
      <p className="my-4">
      ...
      <h2 className="text-4xl font-bold my-7">Links to Other Websites</h2>
      <p className="my-4">
      ...
      <h2 className="text-4xl font-bold my-7">Contact Us</h2>
      <p className="my-4">
      ...
      <ul className="list-disc my-4 pl-10">
        <li>
          ...
          <Link
            href="https://www.lotustape.com/contact"
            rel="external nofollow noopener"
            target="_blank"
            className="hover:underline"
          >
            https://www.lotustape.com/contact
          </Link>
        </li>
      </ul>
    </section>
